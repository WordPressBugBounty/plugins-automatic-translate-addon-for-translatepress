...
$visible_builtin_providers = tpa_get_visible_builtin_ai_provider_keys();

$builtin_ai_translations = array(
	'chrome' => array(
	...
	'edge'   => array(
		'logo'        => 'powered-by-edge-api.png',
		'alt'         => 'Edge Built-in AI',
		'title'       => esc_html__( 'Edge Built-in AI', 'automatic-translate-addon-for-translatepress' ),
		'description' => esc_html__( 'Utilize Edge\'s built-in AI for seamless translation experience.', 'automatic-translate-addon-for-translatepress' ),
		'icon'        => 'edge-ai-translate.png',
		'url'         => 'https://docs.coolplugins.net/doc/microsoft-edge-ai-for-translatepress/?utm_source=tpa_plugin&utm_medium=inside&utm_campaign=docs&utm_content=edge_ai_translations',
	),
);

$other_ai_translations = array(
	array(
...
$visible_builtin_cards = array();
foreach ( $visible_builtin_providers as $provider_key ) {
	if ( isset( $builtin_ai_translations[ $provider_key ] ) ) {
		$visible_builtin_cards[] = $builtin_ai_translations[ $provider_key ];
	}
}

$ai_translations = array_merge( $visible_builtin_cards, $other_ai_translations );
